import performImg from "@/../public/img/choose/pefoming-thumb.png";
import Image from "next/image";
const Perform = () => {
  return (
    <section className="perfoming__section bgwhite overhid pt-120 pb-120">
      <div className="container">
        <div className="row g-4">
          ...
          <div className="col-xxl-5 col-xl-5 col-lg-5">
            <div className="perfoming__thumb">
              <Image src={performImg} alt="perfoming" />
            </div>
          </div>
        </div>
      </div>
